...
-----------------------
        This technique was applied to find the exact accuracy of the model on test set by splitting the training set
        to required number of folds and takes the average of the accuracies among the highest accuracy in each
        train test folds.

"""

# Checking the best classification model for a dataset with K-Fold Cross Validation.
...
# Creating lists for models, kernels, accuracy score and confusion matrix
